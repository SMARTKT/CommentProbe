...
all_store_file = os.getenv("ALL_STORE")
...
if __name__ == "__main__":
    ...
    with open('comment_tagged_tokens.csv', 'w') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_tagged_comment_tokens)


    with open('comment_tokens.csv', 'w') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_comment_tokens)

    pickle.dump( all_comment_tokens, open( os.getenv("ALL_COMMENT_TOKENS"), "wb" ) )
