...
model_name = "/data/user-home/srijoni/CS_Context_Corpus/models/model_200_W10_CBOW_NEG5.bin"
...
with open('name_tokens.csv','r') as file:
...
with open('name_top10_similar_model_200_W10_CBOW_NEG5.csv', 'w') as file:
...
with open('comment_top10_similar_model_200_W10_CBOW_NEG5.csv', 'w') as file:
	writer = csv.writer(file)
	header = ['phrase']
	for i in range(10):
		header.append("most_sim_"+str(i+1))
