...
BASE_PATH = "/data/user-home/srijoni/"
CBOW_PATH = "CS_Context_Corpus/models/model_200_W10_CBOW_NEG5.bin"
ELMO_PATH = os.path.join('cs_contest_corpus','elmo','Exp6','swb', 'model')
